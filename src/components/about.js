  ...
  return (
    <section id='about' className='flex flex-col md:flex-row bg-back1 px-5 pt-20 md:pt-27 pb-20 md:pb-27'>
      <div className='md:w-1/2 flex justify-center mb-5 md:mb-0 px-5'>
        <img src={Aboutimg} alt="About Me" className='w-full md:max-w-md lg:max-w-lg xl:max-w-xl' />
      </div>
      <div className='md:w-1/2 flex px-5'>
        <div className='flex flex-col justify-center'>
          <h1 className='text-2xl md:text-3xl text-white mb-4 md:mb-7 font-hero-font font-bold relative pb-2'>
            About Me
            <span className='block absolute bottom-0 left-0 w-1/6 border-b-4 border-white'></span>
          </h1>
          <p className='text-white font-hero-font text-base md:text-l leading-relaxed md:leading-relaxed text-justify'>
